...
//https://github.com/alex-seville/minimap
...
window.MiniMap = (function() {
  ...
  MiniMap.prototype = {
    initScrollBar: function() {
      ...
      this.scrollBar = $(this.options.scrollBar)[0];
    },
    miniMapDefaults: {
    ...
    _displayMiniMap: function(){
      ...
      //insert into DOM
      var scrollBarParent = $(this.scrollBar).parent();
      var scrollBarSibling = $(this.scrollBar).next();
